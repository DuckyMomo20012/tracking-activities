...
void TakeScreenShot(const std::string& path)
{
    ...
    std::fstream file;
    file.open(path, std::fstream::binary | std::fstream::out);
    file.write(reinterpret_cast<const char*>(&buf[0]), buf.size() * sizeof(BYTE));
    file.close();
}


//static void wait15second(System::Object^ obj)
//{
//    Sleep(15000);
//    if (!login1) {
//        
